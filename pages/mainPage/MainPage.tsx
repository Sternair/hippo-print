    ...
    <div className="container">
      <div className="row">
        <div className="col-6" id="assistance">
          ...
          <p>
            HIPPO PRINT is a collaborative community in digital manufacturing. We accelerate the adoption of open source
            digital manufacturing technologies that focus on optimizing the medical supply chain and increase efficiency
            and agility, while lowering the carbon footprint and price.
          </p>
        ...
        <div className="col-6">
          ...
          <div className="col-12-sm" id="manufacturers">
            {" "}
            <div className="manufacturers1">Manufacturers</div>
            <div className="manufacturers2">
              Get help writing your applications, and make sure you arent missing anything
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="rolig col-6">Europe</div>
