  ...
  return (
    <Layout>
      <div className="container">
        ...
        <br/><br/>MyHeroes GmbH<br/>Wörther Str. 8<br/>10435 Berlin<br/>
        <h2>Represented by</h2>
        Personally liable partner<br/><br/>Bart De Witte, Julia Rohde<br/><br/>
        <h2>Contact Information</h2>
        E-Mail: <a href="mailto:info@hippomakes.com">info@hippomakes.com</a><br/>Internet address: <a
        href="hippomakes.com" target="_blank">hippomakes.com</a><br/><br/>
        <h2>Disclaimer</h2>
        ...
        works subject to copyright protection on our web pages requires the prior consent of the respective owner of
        the rights.
        Individual reproductions of a work are only allowed for private use.
        The materials from these pages are copyrighted and any unauthorized use may violate copyright laws.

        <br/><br/>
        <i>Quelle: </i><a href="http://www.translate-24h.de" target="_blank">Englisch-Übersetzung
        translate-24h.de</a> <br/><br/>
      </div>
    </Layout>
  )
}
